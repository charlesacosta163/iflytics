...
const Banner = () => {
  return (
    <Link target='_blank' href="https://infinitetoolbox.vercel.app" className='bg-[#E2BFB3] px-2 py-4 rounded-lg items-center flex flex-col relative overflow-hidden hover:scale-105 transition-all duration-300 hover:bg-[#FFBE98]'>
