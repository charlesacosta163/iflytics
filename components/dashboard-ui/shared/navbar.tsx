    ...
    <div id="navbar" className="relative">
      ...
      <div className="flex justify-between items-center px-4 py-2 sticky top-0 bg-transparent z-50">
        <div className="flex items-center gap-3">
          ...
          <div className="hidden lg:flex items-center gap-2 bg-pink-50 dark:bg-blue-900/20 border-2 border-pink-200 dark:border-blue-800/30 rounded-[15px] px-4 py-2 hover:shadow-md transition-all duration-200 ml-3.5">
