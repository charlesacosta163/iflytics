...
const InfoCard = ({ value, label, icon: Icon, caption, className = '' }: InfoCardProps) => {
    return (
        <Card className={`flex flex-col justify-between gap-2 h-[150px] p-4 rounded-[25px] duration-200 hover:scale-105 relative tracking-tighter text-light bg-dark ${className} overflow-hidden`}>
